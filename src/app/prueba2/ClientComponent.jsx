...
export default function ClientComponent() {
  ...
  return (
    <div className="w-full h-full bg-transparent overflow-hidden relative">
      ...
      <div className={`absolute top-6 right-6 w-80 transition-all duration-300 ${displayInfo || uaDetails ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8 pointer-events-none"}`}>
      ...
      <div className="absolute bottom-6 right-6 pointer-events-none bg-white/80 backdrop-blur-md px-4 py-2 rounded-xl border border-slate-200">
