 ...
 * @param {number} [props.shiftLeftPx] - Ver mismo prop en VacanciaDetalleModal.
 */
export default function OcupacionDetalleModal({ open, onClose, detalle, isLoading, shiftLeftPx = 0 }) {
  useBodyScrollLock(open);
  const contentReady = open && !isLoading && !!detalle && !(detalle.error && !detalle.fecha_ocupacion);
