...
export default function ParametrosValuacion({
    ...
    return (
        <div className="animate-in fade-in duration-400 sticky bottom-0 flex flex-col overflow-hidden bg-white border-y border-gray-200/80 shadow-sm md:max-h-stack-barra-vh">
