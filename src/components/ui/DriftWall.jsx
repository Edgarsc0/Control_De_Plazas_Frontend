...
/**
 * Muro de tarjetas a la deriva (adaptado de reactbits.dev/components/drift-wall).
 * Columnas de imágenes que fluyen en 3D con leve inclinación al pasar el mouse.
 */
export default function DriftWall({
  ...
  const renderTile = (item, id, colIndex) => {
    ...
    return (
      <div key={id} tabIndex={-1} role="presentation" {...commonProps}>
        {inner}
      </div>
    );
  };
